...
class BackupTableSectionsConfigurator {
    ...
    lazy var defaultTableSection: TableSection = .init(title: title, cellsData: [
    ...
    lazy var inactiveDefaultTableSection: TableSection = .init(title: title, cellsData: [
    ...
    lazy var inactiveRestoreSection: TableSection = .init(title: title, cellsData: [
        CellData(type: SimpleCell.self, viewModel: CellVM(cellValue: BackupToCloudCellItem())),
        CellData(type: SimpleCell.self, viewModel: CellVM(cellValue: getInactive(item: RestoreFromCloudCellItem()))),
    ])
